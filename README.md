...
Projects: 
   ...
   Classroom Projects - I also have a series of classroom projects, notably my 2 different Web Development class where I worked with Python with a Django Framework, React, HTML, CSS, JavaScript, and many other things. I also have a Machine Learning Project from an ML class. These were not all my projects completed during my time at Boston University, if you have any other questions about any other projects or the ones displayed, feel free to ask!
